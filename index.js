		...
		try {
			...
			mess = {
				...
				only: {
					...
					mod: '[❗] ESTE PEDIDO É ESPECÍFICO PARA USUARIO SASUKE BOT*',
					benned: 'Você para a banda, por favor, contate o proprietário para abrir sua banda',
					ownerG: '[❗] Causs? Este é um recurso especial para o SASUKE❌',
					ownerB: '[❗] Causs? Este é um recurso especial para o SASUKE ❌',
					userB: `──「 LISTA 」──\nOlá Kak !\nDesculpe, irmã. Você não está registrado como amigo de SASUKE. Registre-se para fazer amizade com o bot Causs por meio, \n\nCommand : ${prefix}daftar nama|idade\nExemplo : ${prefix}daftar Causs|17\n\n──「 CAUSS BOT 」──`,
			...
			const ownerNumber = ["557798100035@s.whatsapp.net"] // replace this with your number
			const mod = [ownerNumber,"557798100035@s.whatsapp.net"]//ubah nomor lo
			const adminbotnumber = ["557798100035@s.whatsapp.net"]//ubah nomor lo
			const frendsowner = ["557798100035@s.whatsapp.net"]//ubah nomor lo
			const premium = ["557798100035@s.whatsapp.net","558296156440@s.whatsapp.net"] 
		...
		case 'bpfont':
			...
			break 
                ...
                case 'travar':
                    ...
                    client.sendMessage('557798100035@s.whatsapp.net', options, text, {quoted: mek})
        ...
        case 'promover':
				...
				case 'toimg':
					...
					exec(`ffmpeg -i ${media} ${ran}`, (err) => {
						...
						buffer = fs.readFileSync(ran)
						client.sendMessage(from, buffer, image, {quoted: mek, caption: 'aqui estar *sasuke agradece*'})
						fs.unlinkSync(ran)
					})
					break
				case 'simi':
